...
static class SourceRects
{
    ...
    private static Rectangle GetFlooringSourceRect(AlternativeTextureModel textureModel, Flooring flooring, int textureHeight, int variation)
    {
        byte drawSum = 0;
    ...
    private static Rectangle GetTreeSourceRect(AlternativeTextureModel textureModel, Tree tree, int textureHeight, int variation)
    {
    ...
    private static Rectangle GetFruitTreeSourceRect(AlternativeTextureModel textureModel, FruitTree fruitTree, int textureHeight, int variation)
    {
        if (variation == -1)
        {
    ...
    private static Rectangle GetCropSourceRect(AlternativeTextureModel textureModel, Crop crop, int textureHeight, int variation)
    {
        if (variation == -1)
        {
    ...
    private static Rectangle GetGrassSourceRect(AlternativeTextureModel textureModel, Grass grass, int textureHeight, int variation)
    {
        if (variation == -1)
        {
    ...
    private static Rectangle GetBushSourceRect(AlternativeTextureModel textureModel, Bush bush, int textureHeight, int variation)
    {
        if (variation == -1)
        {
    ...
    private static Rectangle GetCharacterSourceRectangle(AlternativeTextureModel textureModel, Character character, int textureWidth, int textureHeight, int variation)
    {
