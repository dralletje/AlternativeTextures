...
namespace AlternativeTextures.Framework.Patches.SpecialObjects
{
    internal class CrabPotPatch : PatchTemplate
    {
        ...
        internal CrabPotPatch(IMonitor modMonitor, IModHelper modHelper)
        ...
        )
        {
            if (__instance.modData.ContainsKey(ModDataKeys.ALTERNATIVE_TEXTURE_NAME))
            {
                ...
                spriteBatch.Draw(
                    ...
                    4f,
                    SpriteEffects.None,
                    ((float)(y * 64) + __instance.directionOffset.Y + (float)(x % 4)) / 10000f
                );
                spriteBatch.Draw(
                    Game1.mouseCursors,
                    Game1.GlobalToLocal(
                    ...
                    1f,
                    SpriteEffects.None,
                    ((float)(y * 64) + __instance.directionOffset.Y + (float)(x % 4)) / 9999f
                );
